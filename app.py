...
cxn_str = 'mongodb+srv://nikocahyana73:sparta@cluster0.gjdpwxq.mongodb.net/?retryWrites=true&w=majority'
...
def detail(keyword):
    ...
    if not definitions:
        return render_template('error.html', error_msg=f'Could not find {keyword}')

    if type(definitions[0]) is str:
        return render_template('error.html', error_msg=f'Could not find {keyword}, did you mean {", ".join(definitions)}?')
